         ...
         case "object":
            if(arg)
            {
               if(arg instanceof Array)
               {
                  ...
                  {
                     _loc4_ = com.Newgrounds.JSON.encode(arg[_loc2_]);
                     if(_loc1_)
                     {
                        _loc1_ += ",";
                     }
               ...
               if(typeof arg.toString != "undefined")
               {
                  for(_loc2_ in arg)
                  {
                     ...
                     {
                        _loc4_ = com.Newgrounds.JSON.encode(_loc4_);
                        if(_loc1_)
                        {
                           _loc1_ += ",";
                        }
                        _loc1_ += com.Newgrounds.JSON.encode(_loc2_) + ":" + _loc4_;
                     }
                  }
                  return "{" + _loc1_ + "}";
               }
